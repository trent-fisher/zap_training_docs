...
icon: house
title: Home
heroImage: https://tft-tailor-fit-technologies.s3.af-south-1.amazonaws.com/logo/TFT_Logo.png
bgImageStyle:
...
highlights:
  - header: Enquiry Management
    ...
    highlights:
      - title: Manage all customer enquiries from booking forms, package requests, and contact form submissions in one centralized location.
      - title: Assign agents, track status, and respond to customer requests efficiently through the integrated workflow system.

  - header: Custom Packages
    description: Create, edit, and publish custom travel packages that appear directly on your travel website.
    image: /assets/image/packages.svg
    bgImageStyle:
  ...
  - header: CRM - Companies
    ...
    image: /assets/image/companies.svg
    features:
  ...
  - header: CRM - Contacts
    ...
    image: /assets/image/contacts.svg
    highlights:
  ...
  - header: CRM - Payments
    ...
    image: /assets/image/payments.svg
    highlights:
      - title: Payment Links
        icon: link
