...
**Package not appearing in table after creation**
- Refresh the page
- Check if package was submitted successfully
- Verify no error messages appeared
- Search for package by title

**Slug not generating**
- Slug generates automatically when title is entered
- Try clicking outside the title field
...
- Check that Valid To is after Valid From
- Check that Sales Period To is after Sales Period From

**Images not uploading**
- Check file size (may have limits)
- Ensure file is image format (JPG, PNG)
...
**Rich text editor not saving formatting**
- Avoid pasting from Microsoft Word (can cause issues)
- Use editor's formatting tools directly
...
**Unsaved changes warning appearing incorrectly**
- This means changes were detected
- Review what you modified
- Save if changes are intentional
- Refresh page to reset if false alarm

**Cannot delete package image**
- Ensure you have permissions
- Try refreshing and trying again
- Contact administrator if deletion is blocked
- Check if image is set as banner (may be protected)

**Destinations not saving**
- Ensure destinations are selected from dropdown
- Check that chips appear for selected destinations
- Click Save after selection
- Verify destinations exist in system

---

## Integration with Website

### How Packages Display to Customers

Created packages may appear on your public website:
- Package listing pages
- Search and filter results
- Featured/popular packages sections
...
**Slug Importance**:
- Slug becomes part of package URL
- Appears in search results
- Should be descriptive and keyword-rich
- Auto-generated from title

**Content Quality**:
- Well-written descriptions improve SEO
...
### Using Downloaded Package Data

Export package list to CSV for:

**Inventory Analysis**:
- Count of active packages
- Price range analysis
- Destination coverage
- Popular vs. standard packages

**Performance Tracking**:
- Identify best-selling packages
- Analyze pricing strategies
- Review seasonal availability
- Plan new package creation
...
A: Duplication feature is not visible in current interface. Create new package manually using existing one as template.

**Q: How many images can a package have?**
A: No specific limit is indicated. Recommended: 5-10 high-quality images.

**Q: Can I reorder images in the gallery?**
A: Image reordering is not evident in current interface. Images display in upload order.

**Q: What happens to bookings if I change package dates?**
A: Changing dates affects future bookings only. Existing bookings remain unchanged. Consult booking system for details.

**Q: Can customers book packages outside the sales period?**
A: No, packages are only bookable during Sales Period From/To dates.

**Q: Can I set different prices for different seasons?**
A: Single price per package. For seasonal pricing, create separate packages with different Valid From/To dates.

**Q: What size should banner images be?**
A: Recommend minimum 1920x1080 pixels for best quality across devices.

**Q: Can I add videos to packages?**
A: Video upload is not shown in current interface. Contact administrator for video capabilities.

**Q: How do I unpublish a package temporarily?**
A: Set Sales Period To to a past date, or adjust Valid To date. Package becomes unbookable.

**Q: Can I see booking statistics for packages?**
A: Package statistics are not shown in this interface. Check reporting or analytics modules.

---

## Quick Reference Card

**Navigation**: Admin → Packages → Custom Packages

**Key Actions**:
- **Add Package**: Opens form to create new package
- **Edit Icon**: Opens package details for editing
- **Download**: Exports packages to CSV
- **Search**: Find packages by keyword
- **Preview**: View package as customers see it
- **Save**: Saves all changes to package
...
- Set realistic dates
- Check inclusions match description
...
For additional assistance with the Custom Packages module, contact your system administrator or technical support team.